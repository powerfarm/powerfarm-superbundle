# ADR 0006: No Continuum workflow DSL
...
The ledger records acts and semantic invariants. Workflow semantics remain with execution engines such as ADK. Unknown authorized act kinds remain representable.
